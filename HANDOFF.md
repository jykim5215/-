...
- **최종 갱신**: 2026-08-10
- **단계**: **v1.4.0 — Play 출시 준비 완료(스토어 업로드는 사람이 해야 함)**
  (릴리즈 목록: https://github.com/jykim5215/-/releases — 태그는 `vocacard-v<버전>`.
  v1.4.0 부터 릴리즈에 GitHub 배포용 `.apk` 와 Play 업로드용 `.aab` 가 함께 붙는다)
