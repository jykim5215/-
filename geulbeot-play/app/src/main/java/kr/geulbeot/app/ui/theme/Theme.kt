...
fun GeulbeotTheme(
    ...
    if (!view.isInEditMode) {
        SideEffect {
            ...
            // No statusBarColor/navigationBarColor here: the system ignores both from API 35, and
            // the app draws edge to edge, so the bars show whatever is behind them. What still
            // matters is whether their icons are drawn dark or light.
